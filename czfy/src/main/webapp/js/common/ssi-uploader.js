...
(function (root, factory) {
    ...
    Ssi_upload.prototype.init = function (element) {
        ...
        var $chooseBtn = $('' +
         ...
         '</span>').append(element);
        var $uploadBtn = $('<button id="" class="ssi-uploadBtn ssi-button success ssi-hidden" >' +
         '<span class="ssi-btnIn">' + this.language.upload + '&nbsp;</span>' +
         '<div id="ssi-up_loading" class="ssi-btnIn"></div></button>');
        var $clearBtn = $('<button id="" class="ssi-clearBtn ssi-hidden ssi-button info" >' + this.language.clear +
         '</button>');
